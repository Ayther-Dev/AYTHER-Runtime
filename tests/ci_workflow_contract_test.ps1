...
Assert-Condition ($lock.release.tag -ceq "v0.1.0-rc.9") `
    "MAD-005 requires the Engine v0.1.0-rc.9 lock."
...
Assert-Condition ($workflowText -match 'v0\.1\.0-rc\.9') `
    "CI must reject any Engine lock other than v0.1.0-rc.9."
